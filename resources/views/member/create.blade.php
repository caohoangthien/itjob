...
@section('content')
    <div class="container">
        <div class="row">
            {!! Form::open(['route' => ['signup-member'], 'method' => 'post', 'files' => true, 'class' => 'col-md-6 col-md-offset-3 form-login'])  !!}
            ...
            <div class="form-group">
                ...
                <div class="{!! $errors->has('gender') ? 'has-error' : '' !!}">
                    {!! Form::text('gender', null, ['class' => 'form-control', 'placeholder' => 'Giới tính']) !!}
            ...
            <div class="form-group">
                ...
                <div class="{!! $errors->has('birthday') ? 'has-error' : '' !!}">
                    {!! Form::text('birthday', null, ['class' => 'form-control', 'placeholder' => 'Ngày sinh']) !!}
